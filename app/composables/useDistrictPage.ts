export function useDistrictPage() {
  ...
  const eventTypeLabel: Record<string, string> = {
    ...
    makeup_day: 'Make-Up Day', inclement_weather_day: 'Reserved Weather Day', school_resume: 'School Resumes', school_reopen: 'School Resumes',
    ...
    calendar_reserve: '185th Calendar Day',
  ...
  const eventTypeColor: Record<string, string> = {
    ...
    remote_learning: 'bg-[#eee7ec] text-[#68495f]',
    makeup_day: 'bg-[#f1e5d9] text-[#744c28]',
    inclement_weather_day: 'bg-[#f1e5d9] text-[#744c28]',
    school_resume: 'bg-[#e7efe5] text-[#315b39]',
    school_reopen: 'bg-[#e7efe5] text-[#315b39]',
    quarter_start: 'bg-[#eeeae2] text-[#625b52]',
    quarter_end: 'bg-[#eeeae2] text-[#625b52]',
    grading_period_start: 'bg-[#eeeae2] text-[#625b52]',
    grading_period_end: 'bg-[#eeeae2] text-[#625b52]',
    semester_start: 'bg-[#eeeae2] text-[#625b52]',
    ...
    calendar_reserve: 'bg-[#f1e5d9] text-[#744c28]',
