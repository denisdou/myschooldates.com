  ...
  <div id="add-to-calendar" class="bg-white rounded-xl border border-gray-200 overflow-hidden scroll-mt-24">
    ...
    <div class="p-6 border-b border-gray-100">
      ...
      <p class="text-xs text-gray-600 mt-2">
        This is an unofficial one-time import file generated by MySchoolDates from the verified {{ year }} {{ districtName }} calendar. It will not automatically update if the district revises its calendar, so always verify schedule changes with the district.
      </p>
    </div>
