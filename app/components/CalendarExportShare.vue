...
const pdfHeading = computed(() => isArchivedPdfCopy.value
  ? `${props.districtName} Calendar ${displayYear.value}: Official Calendar PDF — Archived Copy`
  : hasGeneratedPrintablePdf.value
  ? `${props.districtName} Calendar ${displayYear.value}: Printable PDF`
  : isDrivePdf.value
  ? `${props.districtName} Calendar ${displayYear.value}: Printable PDF`
  : (props.cal?.pdfHeading ?? props.cal?.meta?.pdfHeading ?? `${props.districtName} Calendar ${displayYear.value}: Printable PDF`)
)
const pdfDescription = computed(() => isArchivedPdfCopy.value
  ...
  : isDrivePdf.value
  ? `Open or print the calendar PDF linked from the ${props.districtName} calendar page. Check the district calendar page for revisions before making travel or childcare plans.`
  : `Open or print the official calendar PDF published by ${props.districtName}. Check the district calendar page for revisions before making travel or childcare plans.`
)
