...
<template>
  <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
    <div class="bg-white rounded-xl border border-gray-200 p-5">
      ...
      <time :datetime="cal.firstDay" class="block text-lg font-bold text-gray-900">{{ formatDate(cal.firstDay) }}</time>
      <ClientOnly>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-5">
      ...
      <time :datetime="cal.lastDay" class="block text-lg font-bold text-gray-900">{{ formatDate(cal.lastDay) }}</time>
    </div>
    <div class="bg-white rounded-xl border border-gray-200 p-5">
      ...
      <div v-if="cal.totalSchoolDays" class="text-lg font-bold text-gray-900">{{ cal.totalSchoolDays }} days</div>
