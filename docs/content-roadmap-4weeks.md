...
|----------|----|------|-----------|------------|------|
| 2026-08-23 | Alabama | Madison County School System | `/madison-county-schools-calendars` | 2026-2027 | 基于 MCSS 官方网站、MCSS Calendars 页面、官网 PNG logo、Board Approved 2026–27 Academic Calendar、用户提供的本地 PDF 及当前官方直链文件创建。一页 PDF 已完成嵌入文字提取和整页高分辨率视觉核对；本地文件与官网当前文件逐字节一致，SHA-256 为 `c4a33eb7b62168095af383cbc64c8caf5a5b683bce93a94bfb7bc6a29c71bcc6`。页面重点保留 Sept. 4 / Feb. 12 E-Learning and Collaboration Days 仍为 instructional dates、Dec. 18 / May 26 两个 student half-days、April 30 已排定的 Weather Day / School System Closed、Winter Break 后 Jan. 4 Work Day 与 Jan. 5 实际返校日，以及 student / teacher / 212-plus-day / 240-day employee break ranges 的不同范围。PDF 未打印全年学生天数；按颜色月格核得第一学期 86、第二学期 94，共 180 个 student instructional dates，并明确标为 MySchoolDates 派生计数。用户提供的 Spanish-labeled 扩展入口与 English PDF URL 完全相同且实际仍打开英文文件，因此页面披露该链接问题但不把它误标为独立西班牙语日历。2025–26 与 2027–28 至 2029–30 PDF URL 未提供，暂不创建。创建日期：2026-08-23。 |
| 2026-08-23 | Alabama | Birmingham City Schools | `/birmingham-city-schools-calendar` | 2026-2027 | 基于 BCS 官网、Calendar Documents 页面、官网 PNG logo、用户提供的本地 English PDF，以及官方 Spanish 与 Assessment Calendar 链接创建。English 一页文件已完成文字提取、整页渲染和视觉核对，SHA-256 为 `a245d09a7be9cfad950abaf50fb088fcf6e5168ee64bf309c9e2bdc7234ac209`。页面重点保留 180 student days、187 teacher days、44+38+49+49 四个 reporting periods、Oct. 23 与 March 8 仍计入 student total 的 e-Learning / Parent Conference Days、Fall / Spring Intersession 与另外两段 Break 的区别、Dec. 18 early dismissal，以及 Winter Holidays 后 Jan. 4 professional development、Jan. 5 teacher workday 与 Jan. 6 实际返校日。当前官网 English 文件名仍含 `Draft`，页面明确披露并设置替换文件复核触发条件；Spanish 与 Assessment Calendar 作为官方 companion resources 收录，但 Assessment Calendar 不用于 attendance dates 或 ICS。2025–26、2027–28、2028–29、2029–30 PDF URL 未提供，暂不创建。创建日期：2026-08-23。 |
| 2026-08-23 | Alabama | Jefferson County Schools | `/jefferson-county-schools-al-calendar` | 2025-2026, 2026-2027 | 基于 JEFCOED 官网、官方 Calendar Documents 页面、官网 PNG logo、用户提供的两份本地 English PDF，以及 2026–27 官方 Spanish PDF 创建。三份一页文件均完成文本提取、整页渲染和视觉核对；2025–26 English、2026–27 English、2026–27 Spanish 的 SHA-256 分别为 `d4dc5bfb14f66d1f4145c8be5f599bc9ce8339bc23251e2590cf78f98f206494`、`f5507b03407e35758509b6347bac835884ee912ccd6ba72cf87290e1a8ba723f`、`8d6b0e13f091d75985d9215284ced9602b799952b819486527e6a3d077192ba8`。页面重点区分 E-Learning student days 与 Professional Development / Teacher Workdays，保留 High Schools Only Opportunity Days、conditional weather make-up dates、Holiday Break 后 Jan. 4–5 staff days 与 Jan. 6 实际返校日。2025–26 官方文件内部将 March E-Learning 同时写成 March 6 和 March 9，页面依据月历格与主事件表两处一致记录采用 March 6，并公开披露冲突。2026–27 English 标注 Board Approved 1/22/26，Spanish 标注 2/22/26；两版日程一致，页面将审批日期差异作为源文件标注问题说明。创建日期：2026-08-23。 |
| 2026-08-23 | Alabama | Montgomery Public Schools | `/montgomery-public-schools-calendars` | 2026-2027 | 基于 MPS 官方网站、2026–27 Back to School Guide、Board approval announcement、官网 PNG logo、官方四页 Academic Calendar PDF 和用户提供的本地同源文件创建。官方直链与本地文件逐字节一致，SHA-256 为 `662192f6f2210d018ad9cbfe7478c982111bf2b6ff4735d03e2e47ebe89dbbb9`；四页均完成文字提取、整页渲染和视觉核对。页面重点保留 180 student days、187 teacher days、44+42+47+47 四季度天数、四个 Asynchronous Learning Days、学生与教师不同的 Winter Break 边界、progress-report / report-card dates，以及 MPS Vacation Planner 将相邻周末计入 3 / 9 / 17-day family-planning windows 的口径。Central-office closures、teacher-only dates、Senior Exams、graduation 和 Summer School 作为上下文展示，但不全部写入 districtwide family ICS。2025–26、2027–28、2028–29、2029–30 PDF URL 未提供，未创建对应学年文件。新建无年份 slug 按当前规则使用复数 `calendars`。创建日期：2026-08-23。 |
| 2026-08-22 | Kentucky | Fayette County Public Schools | `/fayette-county-public-schools-calendars` | 2026-2027, 2027-2028 | 基于 FCPS 官方网站、Calendar 页面、官网 PNG crest、两份 board-approved Students & Families Instructional Calendar PDF、用户提供的两份本地同源文件，以及 2026–27 Fayette County Preschool Program 官方扩展日历创建。两份主日历均为 13 页、Preschool 日历为 12 页，三份文件均完成嵌入文字提取、逐页渲染和关键月份高分辨率视觉核对；本地 2026–27 与 2027–28 文件均与官网当前直链逐字节一致，SHA-256 分别为 `afd27b69723185b723e2a8c06efb8548c15656ad3dd3f68262d581ce6d029ffa`、`c123629fe8ad875a4e9cf3bcedb09f27d6f838b5684ed498b3baa58d974b54ba`，Preschool 官方文件为 `16783c21e5ff73d9c00b66a0bfda96dd379c1bafe88b7758f631e6ebcdd52a2f`。页面重点保留 Fall / Winter / Spring Break 后额外 no-class 或 Teacher/Staff Work Day 与真实返校日的区别，按 superintendent discretion 启用的 possible weather make-up dates，以及 2026–27 May 26 pending make-up days、2027–28 May 24 tentative last day 的状态边界；所有候选补课日可见但不作为确认上课日写入 ICS 或确定日期 Schema。2026–27 Preschool 按独立 program calendar 处理，保留 Aug. 24–25 PM、Aug. 26–27 AM / full-day 的分批开学及额外 Preschool-only no-class dates，不混入 K–12 主 ICS。两份主 PDF 均注明 William Wells Brown Elementary 使用略有不同的 Promise Academy calendar，2027–28 还明确其暑期早几天开学；页面保留该例外但不推断未发布日期。2027–28 PDF 将 May 26 误写为 `Possibly Weather Make-Up Day`，页面只规范为 `Possible` 并在审核说明披露。2025–26、2028–29、2029–30 PDF URL 未提供，暂不创建。创建日期：2026-08-22。 |
| 2026-08-22 | Tennessee | Hamilton County Schools | `/hamilton-county-schools-calendars` | 2026-2027, 2027-2028 | 基于 HCS 官方网站、Calendar 页面、官网 PNG logo、两份 English School Calendar、用户提供的本地同源 PDF，以及两个学年的 Spanish 官方日历创建。两份 English 一页文件均完成文字提取、整页高分辨率视觉核对和颜色单元格复核；2026–27 SHA-256 为 `e85771fbcd892de8a2bd766e45707e776ed57c19d184b9ba59af6fd3e076bd78`，2027–28 为 `01e9ff184e37747f484e85f2ba3da823e4ab34aa4d6ae3cbf4c4ac613bd48614`。页面重点保留红色 student half-days、break 后紧接 professional-development day 导致的实际返校日、174/173 green student dates 与 6/7 blue PD days组成的 180 quarter total、单独的 201 calendar-category total，以及 quarter、midterm、report-card dates。Spanish 文件按同一学区日程的官方翻译收录，不包装为替代学制。2027–28 官方页面标注 Approved 4/16/26，但 English 本地文件名仍含 Draft 且 PDF 内未打印 approval line；页面保留该来源差异并要求人工复核。2025–26、2028–29、2029–30 PDF URL 未提供，暂不创建。新建无年份 slug 按当前规则使用复数 `calendars`。创建日期：2026-08-22。 |
| 2026-08-22 | Tennessee | Rutherford County Schools | `/rutherford-county-schools-calendar` | 2026-2027 | 基于 RCS 官方网站、Academic Calendars 页面、官网 PNG logo、官方 English Academic Calendar、用户提供的本地同源 PDF，以及 Spanish、Arabic 两份官方翻译日历创建。三份一页文件均完成文本提取和整页高分辨率视觉核对；英文官方 URL 虽以 `.docx` 结尾，服务器实际返回 PDF，且本地文件与官方直链逐字节一致，SHA-256 为 `1f718e9bae061ac2884c38928a2cbf9f88275faad016d2a3659b6edac7f0d98b`。页面重点保留 Aug. 7 两小时 student orientation 与 Aug. 10 first full day 的开学边界，Dec. 18 两小时 abbreviated day，Winter Break 后 Jan. 4 in-service / safety day 与 Jan. 5 实际返校日，May 27 teacher workday 与 May 28 两小时 last day 的区别，以及 nine-week endings、progress-report windows 和 parent/teacher conferences；conference dates 未被官方标为停课日，因此按 academic events 处理。Spanish 与 Arabic 文件按同一 district schedule 的语言版本收录，不包装为替代学制。2025–26 与 2027–28 至 2029–30 PDF URL 未提供，暂不创建。创建日期：2026-08-22。 |
...
| 2026-08-22 | Colorado | Jeffco Public Schools | `/jeffco-public-schools-calendar` | 2026-2027, 2027-2028 | 基于官方 Jeffco Calendar & Events 页面、官网 SVG logo、两份 English District Family Calendar 官方 PDF、用户提供的两个本地同源副本，以及两学年各自的 Spanish、Vietnamese、Russian 官方翻译新建；两份一页 English PDF 均完成全文提取、整页高分辨率视觉核对和远程/本地 SHA-256 比对，2026–27 为 `6773c19b788e1984f99f1c1d6b95b3eec10273530d918e101866e2759810acf6`，2027–28 为 `75cde16675b39b9d7d20072c03856163d815329f442d7179e4b2b6ebb66a77cc`。页面重点解释 79 + 92 = 171 student contact days、两学年不同的 semester teacher-workday split 但总计均为 185、staff-development dates 与 potential snow make-up days 的条件性、school-level modified contact days 不在 district PDF 中、break 后实际返校日、以及 2026–27 district-run PK–12 最后一天提前 2.5 小时且明确排除 charter schools；2027–28 PDF 未重复该提前放学说明，因此不跨年继承。条件性 snow make-up dates 不进入一次性 ICS，翻译 PDF 按同一主日历的语言版本处理。2025–26、2028–29、2029–30 PDF URL 未提供，未新建对应学年文件。创建日期：2026-08-22。 |
...
| 108 | Colorado | Jeffco Public Schools | Denver | ✓ 新建完成：`jeffco-public-schools-calendar`（2026-08-22） |
...
| 184 | Tennessee | Hamilton County Schools | Chattanooga | ✓ 已完成：`hamilton-county-schools-calendars`（2026-08-22） |
| 185 | Tennessee | Rutherford County Schools | Nashville | ✓ 已完成：`rutherford-county-schools-calendar`（2026-08-22） |
| 186 | Tennessee | Williamson County Schools | Nashville | ✓ 已完成：`williamson-county-schools-calendar`（2026-08-22） |
| 187 | Kentucky | Jefferson County Public Schools | Louisville | ✓ 已完成：`jeffco-public-schools-calendar`（2026-08-22）  |
| 188 | Kentucky | Fayette County Public Schools | Lexington | ✓ 已完成：`fayette-county-public-schools-calendars`（2026-08-22） |
| 189 | Alabama | Mobile County Public Schools | Mobile | ✓ 已完成：`mobile-county-public-schools-calendars`（2026-08-23） |
| 190 | Alabama | Jefferson County Schools | Birmingham | ✓ 已完成：`jefferson-county-schools-al-calendar`（2026-08-23） |
| 191 | Alabama | Montgomery Public Schools | Montgomery | ✓ 已完成：`montgomery-public-schools-calendars`（2026-08-23） |
| 192 | Alabama | Birmingham City Schools | Birmingham | ✓ 已完成：`birmingham-city-schools-calendar`（2026-08-23） |
| 193 | Alabama | Madison County Schools | Huntsville | ✓ 已完成：`madison-county-schools-calendars`（2026-08-23） |
