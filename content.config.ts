...
const eventSchema = z.object({
  ...
  type: z.enum([
    ...
    'makeup_day', 'quarter_start', 'quarter_end', 'semester_start', 'semester_end', 'graduation',
  ]),
  ...
  collections: {
    ...
    calendars: defineCollection({
      ...
      schema: z.object({
        ...
        calendarOverviewLayout: z.boolean().optional(),
        faqAccordion: z.boolean().optional(),
        faqDefaultOpenCount: z.number().optional(),
        ...
        faqDisplayLimit: z.number().optional(),
        ...
        hideHeroDownloadLink: z.boolean().optional(),
        moveCalendarExportBeforeAllDates: z.boolean().optional(),
